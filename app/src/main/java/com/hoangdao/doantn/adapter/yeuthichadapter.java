...
public class yeuthichadapter extends RecyclerView.Adapter<yeuthichadapter.ItemHoler> {
    Context context;
    ...
    @NonNull
    @Override
    public yeuthichadapter.ItemHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.dong_yeuthich, null);
        yeuthichadapter.ItemHoler itemHoler = new yeuthichadapter.ItemHoler(v);
        return itemHoler;
    }
    ...
    public class ItemHoler extends RecyclerView.ViewHolder {
        public ImageView img,imgyeuthich;
        ...
        public ItemHoler(View itemView) {
            ...
            txttensp = itemView.findViewById(R.id.tengiohang);
            txtgiasp = itemView.findViewById(R.id.giagiohang);
