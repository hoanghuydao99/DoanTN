...
public class SPAdminAdapter extends RecyclerView.Adapter<SPAdminAdapter.ItemHoler> {
    Context context;
    ...
    public ItemHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.customsp,parent,false);
