        ...
        btnthem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (tensp.length() > 0 && giasp.length() > 0 && realpath.length() > 0 && soluong.length() > 0 && mota.length() > 0 && idloaisp.length() > 0) {
                                    ...
                                    callback.enqueue(new Callback<String>() {
                                        ...
                                        public void onResponse(Call<String> call, Response<String> response) {
                                            ...
                                            if (resulit.equals("Success")) {
                                                Toast.makeText(Themsp.this, "Thêm thành công", Toast.LENGTH_SHORT).show();

                                                Intent intent = new Intent(getApplicationContext(),QLsanpham.class);
                    ...
                    Toast.makeText(Themsp.this, "Hãy nhập đủ thông tin", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
